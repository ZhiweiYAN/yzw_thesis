...
%      \begin{enumerate}[{[}1{]}]
[1] Yan  ZW , Liu GZ , Su R. Call Admission Control Scheme with Normalized Quality of Sevice Metric in IEEE802.16 Networks[J].  Wireless Communication and Mobile Computing. Accpted(SCI 源, DOI: 10.1002/wcm.2343).
...
{\wuhao \leftskip=3ex\parindent=-3ex
%      \begin{enumerate}[{[}1{]}]
[1] Call Admission Control Scheme with Normalized Quality of Sevice Metric in IEEE802.16 Networks[J].  Wireless Communication and Mobile Computing. DOI: 10.1002/wcm.2343.
