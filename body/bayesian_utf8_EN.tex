...
The model can guide the behavior of players under an incompleted information situation. 
Each player make his reasonable decision although they do not accquire the whole and complete information of other players in the game.

\section{Traffic Type and Game Model}
\subsection{Discrete and Continous Traffic Class}
